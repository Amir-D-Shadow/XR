...
from MultiViewREX import MultiViewREX
...
class alpha_model(tf.keras.Model):
   ...
   def __init__(self,**kwargs):
      ...
      #MVREX_1 in : 640 x 640 x 32 out: 319 x 319 x 64
      MVREX_info = {}
      MVREX_info["num_res_units"] = 1

      MVREX_info["CBL_1"] = (64,3,2,"valid")
      MVREX_info["CBL_2"] = (64,1,1,"same")

      res_unit_info = {}
      res_unit_info["CBL_1"] = (32,1,1,"same")
      res_unit_info["CBL_2"] = (64,3,1,"same")
      MVREX_info["res_unit"] = res_unit_info
      
      #MVREX_1
      self.MVREX_1 = MultiViewREX(MVREX_info)

      #$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$

      #MVREX_2 in : 319 x 319 x 64 out : 159 x 159 x 128
      MVREX_info = {}
      MVREX_info["num_res_units"] = 2

      MVREX_info["CBL_1"] = (128,3,2,"valid")
      MVREX_info["CBL_2"] = (128,1,1,"same")
      MVREX_info["CBL_X"] = (64,1,1,"same")

      res_unit_info = {}
      res_unit_info["CBL_1"] = (64,1,1,"same")
      res_unit_info["CBL_2"] = (128,3,1,"same")
      MVREX_info["res_unit"] = res_unit_info

      #MVREX_2
      self.MVREX_2 = MultiViewREX(MVREX_info)


      #$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$

      #MVREX_8_branch_1 in : 159 x 159 x 128  out : 79 x 79 x 512 -- branch 1
      MVREX_info = {}
      MVREX_info["num_res_units"] = 8

      MVREX_info["CBL_1"] = (256,3,2,"valid")
      MVREX_info["CBL_2"] = (256,1,1,"same")
      MVREX_info["CBL_X"] = (128,1,1,"same")

      res_unit_info = {}
      res_unit_info["CBL_1"] = (128,1,1,"same")
      res_unit_info["CBL_2"] = (256,3,1,"same")
      MVREX_info["res_unit"] = res_unit_info


      #MVREX_8_branch_1 -- branch_1
      self.MVREX_8_branch_1 = MultiViewREX(MVREX_info)


      #$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$

      #MVREX_8_branch_2 in : 79 x 79 x 256 out : 39 x 39 x 1024 --- branch_2
      MVREX_info = {}
      MVREX_info["num_res_units"] = 8

      MVREX_info["CBL_1"] = (512,3,2,"valid")
      MVREX_info["CBL_2"] = (512,1,1,"same")
      MVREX_info["CBL_X"] = (256,1,1,"same")

      res_unit_info = {}
      res_unit_info["CBL_1"] = (256,1,1,"same")
      res_unit_info["CBL_2"] = (512,3,1,"same")
      MVREX_info["res_unit"] = res_unit_info
      
      #MVREX_8_branch_2 -- branch_2
      self.MVREX_8_branch_2 = MultiViewREX(MVREX_info)
      

      #$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$

      #MVREX_4 in : 39 x 39 x 512 out : 19 x 19 x 1024
      MVREX_info = {}
      MVREX_info["num_res_units"] = 4

      MVREX_info["CBL_1"] = (1024,3,2,"valid")
      MVREX_info["CBL_2"] = (1024,1,1,"same")
      MVREX_info["CBL_X"] = (512,1,1,"same")

      res_unit_info = {}
      res_unit_info["CBL_1"] = (512,1,1,"same")
      res_unit_info["CBL_2"] = (1024,3,1,"same")
      MVREX_info["res_unit"] = res_unit_info
      
      #MVREX_4 
      self.MVREX_4 = MultiViewREX(MVREX_info)
   ...
   def call(self,inputs,train_flag=True):
      ...
      #MVREX_1
      MVREX_1 = self.MVREX_1(CBL_1,train_flag)

      #MVREX_2
      MVREX_2 = self.MVREX_2(MVREX_1,train_flag)

      #MVREX_8_branch_1 ----------------------------------------- branch 1
      MVREX_8_branch_1 = self.MVREX_8_branch_1(MVREX_2,train_flag)

      #MVREX_8_branch_2 ----------------------------------------- branch 2
      MVREX_8_branch_2 = self.MVREX_8_branch_2(MVREX_8_branch_1,train_flag)

      #MVREX_4
      MVREX_4 = self.MVREX_4(MVREX_8_branch_2,train_flag)

      #CBL_1_neck
      CBL_1_neck = self.CBL_1_neck(MVREX_4,train_flag)
      ...
      TCBL_connect_branch_2 = self.TCBL_connect_branch_2(MVREX_8_branch_2,train_flag)
      ...
      TCBL_connect_branch_1 = self.TCBL_connect_branch_1(MVREX_8_branch_1,train_flag)
