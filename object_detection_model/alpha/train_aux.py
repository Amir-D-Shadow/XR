...
with strategy.scope():
   ...
   def compute_loss(labels,predictions):
      ...
      #large 0.3
      large_obj_loss_03 = loss_object(labels[0],predictions[3])

      #medium 0.3 
      medium_obj_loss_03 = loss_object(labels[1],predictions[4])

      #small 0.3
      small_obj_loss_03 = loss_object(labels[2],predictions[5])

      #large 0.8
      large_obj_loss_08 = loss_object(labels[0],predictions[6])

      #medium 0.8
      medium_obj_loss_08 = loss_object(labels[1],predictions[7])

      #small 0.8
      small_obj_loss_08 = loss_object(labels[2],predictions[8])

      #total loss
      total_loss = large_obj_loss + medium_obj_loss + small_obj_loss + large_obj_loss_03*0.3 + medium_obj_loss_03*0.3 + small_obj_loss_03*0.3 + large_obj_loss_08*0.8 +  medium_obj_loss_08 * 0.8 + small_obj_loss_08 * 0.8
...
#preprocessing label
input_path = f"{cur_path}/gdrive/MyDrive/annotations/test100_annotations.csv"
save_path = f"{cur_path}/gdrive/MyDrive/data"
